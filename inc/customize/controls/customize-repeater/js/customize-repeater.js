jQuery( document ).ready(function($) {
	...
	$('.sortable_repeater_control').each(function() {
		...
		var defaultValuesArray = new Array("banner","activity","about","popular-destination","explore","popular-cuisines","popular-packages","experience","how-to-process","why-choose-us","team","testimonial","blog");
