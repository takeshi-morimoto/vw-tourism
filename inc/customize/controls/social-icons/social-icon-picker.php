...
class vw_tourism_pro_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="total-icon-list clearfix">
                    ...
                    <?php
                    $vw_tourism_pro_font_awesome_icon_array = vw_tourism_pro_font_awesome_icon_array();
                    foreach ($vw_tourism_pro_font_awesome_icon_array as $vw_tourism_pro_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_tourism_pro_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_tourism_pro_font_awesome_icon).'"></i>
                                <span class="vw-social-class">'.esc_attr($vw_tourism_pro_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vw_tourism_pro_customizer_script() {
...
add_action( 'customize_controls_enqueue_scripts', 'vw_tourism_pro_customizer_script' );

if(!function_exists('vw_tourism_pro_font_awesome_icon_array')){
    function vw_tourism_pro_font_awesome_icon_array(){
